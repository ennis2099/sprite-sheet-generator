...
const DEMO_SPRITES = [
  ...
  { name: "sword_01", w: 28, h: 34, isAi: false, svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><rect x="7" y="1" width="2" height="10" fill="#F59E0B"/><rect x="5" y="10" width="6" height="2" fill="#92400E"/><rect x="6" y="12" width="4" height="3" fill="#78350F"/></svg>` },
  { name: "coin_01", w: 24, h: 24, isAi: false, svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="#F59E0B"/><circle cx="8" cy="8" r="4" fill="#D97706"/></svg>` },
  { name: "potion_01", w: 28, h: 30, isAi: false, svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><rect x="6" y="1" width="4" height="3" fill="#94A3B8"/><rect x="5" y="4" width="6" height="8" rx="2" fill="#22C55E" opacity="0.8"/></svg>` },
  { name: "gem_01", w: 24, h: 24, isAi: false, svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><polygon points="8,2 14,7 11,14 5,14 2,7" fill="#06B6D4"/><polygon points="8,2 11,7 8,14 5,7" fill="#22D3EE" opacity="0.5"/></svg>` },
  { name: "shield_01", w: 26, h: 26, isAi: false, svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 1L2 4v5c0 3.5 6 6 6 6s6-2.5 6-6V4z" fill="#0891B2"/></svg>` },
  { name: "heart_01", w: 22, h: 22, isAi: false, svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14s-5.5-3.5-5.5-7c0-2 1.5-3.5 3.5-3.5 1.2 0 2 .8 2 .8s.8-.8 2-.8c2 0 3.5 1.5 3.5 3.5 0 3.5-5.5 7-5.5 7z" fill="#EF4444"/></svg>` },
  { name: "key_01", w: 22, h: 26, isAi: false, svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><circle cx="5" cy="5" r="3" fill="none" stroke="#F59E0B" stroke-width="2"/><rect x="7" y="4" width="7" height="2" fill="#F59E0B"/><rect x="12" y="6" width="2" height="3" fill="#F59E0B"/></svg>` },
];
